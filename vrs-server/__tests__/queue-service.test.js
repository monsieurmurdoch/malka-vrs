...
jest.mock('../database', () => ({
    ...
    attachVriInvitesToQueue: jest.fn().mockResolvedValue([]),
    activateVriInvitesForQueue: jest.fn().mockResolvedValue([]),
    expireVriInvitesForQueue: jest.fn().mockResolvedValue([]),
