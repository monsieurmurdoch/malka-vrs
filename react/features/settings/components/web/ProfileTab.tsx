...
class ProfileTab extends AbstractDialogTab<IProps, any> {
    ...
    /**
     * Changes the preferred UI language for the user.
     *
     * @param {string} value - The next language code.
     * @returns {void}
     */
    _onLanguageChange(event: ChangeEvent<HTMLSelectElement>) {
        super._onChange({ currentLanguage: event.target.value });
    }
        ...
        return (
            <div className = { classes.container } >
                ...
                <Select
                    ...
                    label = { t('profile.preferredLanguageLabel') }
