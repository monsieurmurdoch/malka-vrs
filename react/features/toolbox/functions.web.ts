...
import RequestInterpreterButton from './components/web/RequestInterpreterButton';
import ActiveInactiveToggleButton from './components/web/ActiveInactiveToggleButton';
...
export function getAllToolboxButtons(_customToolbarButtons?: {
    ...
    // Role-based buttons - will be filtered at runtime based on user role
    const requestInterpreter = {
        key: 'requestInterpreter',
        Content: RequestInterpreterButton,
        group: 2
    };

    const activeInactiveToggle = {
        key: 'activeInactiveToggle',
        Content: ActiveInactiveToggleButton,
        group: 2
    };
