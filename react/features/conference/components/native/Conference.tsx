...
class Conference extends AbstractConference<IProps, State> {
    ...
    _renderContent() {
        ...
        const useVrsLayout = isVrsSession(_room);
        ...
        return (
            <>
                ...
                <View
                    ...
                    {
                        useVrsLayout || _shouldDisplayTileView
                    ...
                    { !useVrsLayout && !_shouldDisplayTileView && <LonelyMeetingExperience /> }
    ...
    _renderContentForReducedUi() {
        const { _connecting, _room } = this.props;
        const useVrsLayout = isVrsSession(_room);

        return (
            <>
                {useVrsLayout ? <VRSLayout /> : <LargeVideo onClick = { this._onClick } />}
