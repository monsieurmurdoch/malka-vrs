...
var config = {
     ...
     None of the fields are mandatory and the response must have the shape:
    {
        ...
        customTheme: {
            palette: {
                ...
                action01Active: "#00003C",
                disabled01: "#848395",
                actionDanger: "#CE0F13",
                actionDangerHover: "#E04757",
                actionDangerActive: "#84151E",
                field01: "#0D1A38",
                success01: "#89BD0E",
                warning01: "#F47D22"
            }
    ...
    */
    ...
    vrs: {
        ...
        callLogging: {
            enabled: true,
            // Log call events: started, ended, duration, participants
            logEvents: true,
            // Log quality metrics: packet loss, bitrate, etc.
            logQuality: true,
            // Store call recordings reference
            logRecordings: true
        },

        // Queue settings
        queue: {
            // Max wait time before alerting (minutes)
            maxWaitTime: 10,
            // Estimated wait time per person in queue (minutes)
            estimatedWaitPerPerson: 2,
            // Auto-assign interpreter when available
            autoAssign: true
        },

        // Interpreter settings
        interpreter: {
            // Max simultaneous calls per interpreter
            maxCalls: 1,
            // Break duration between calls (minutes)
            breakDuration: 5,
            // Auto-set unavailable after call ends
